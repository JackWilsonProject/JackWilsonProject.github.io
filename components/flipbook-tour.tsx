            ...
            <div className="border-l-2 border-[#8b6e46] pl-4">
              ...
              <ul className="space-y-2">
                <li className="ink-text text-sm">
                  <a 
                    href="https://archive.org/details/threeessaysonpic00gilp" 
                    target="_blank" 
              ...
              <ul className="space-y-2">
                ...
                <li className="ink-text text-sm">
                  <a 
                    ...
                    className="text-[#8b6e46] underline hover:text-[#5a4632]"
                  >
                    Thomas Weiskel. <em>The Romantic Sublime</em> (1976)
                  </a>
                </li>
                <li className="ink-text text-sm">
                  <a 
                    ...
                    className="text-[#8b6e46] underline hover:text-[#5a4632]"
                  >
                    Frances Ferguson. <em>Solitude and the Sublime</em> (1992)
                  </a>
                </li>
              </ul>
            </div>
